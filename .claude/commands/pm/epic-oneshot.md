...
This will:
- Read the epic
- Create task files sequentially
...
- Create sub-issues sequentially
...
Both commands handle their own error checking and validation. This command just orchestrates them in sequence.
